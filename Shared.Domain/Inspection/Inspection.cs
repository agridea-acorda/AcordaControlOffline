...
namespace Agridea.Acorda.AcordaControlOffline.Shared.Domain.Inspection
{
    public class Inspection: AggregateRoot
    {
        ...
        public Inspection RequireActionOfDocuments(string actionsOrDocuments, DateTime dueDate)
        {
            Compliance = new Compliance(actionsOrDocuments, dueDate);
            return this;
        }
        ...
        public Inspection Finish(FinishStatus finishStatus)
        {
